use crate::{
    state::{
        Ask, Bid, BidId, BidKey, CollectionBid, CollectionBidId, CollectionBidKey, SaleType,
        SudoParams, TokenId,
    },
};
...
pub struct InstantiateMsg {
    ...
    pub max_finders_fee_bps: u64, // Min value for bids and asks
...
impl BidOffset {
    pub fn new(price: Uint128, token_id: TokenId, bid_id: BidId, collection: Addr) -> Self {
        BidOffset {
            price,
            token_id,
            bid_id,
...
impl CollectionOffset {
    pub fn new(collection: String, token_id: TokenId, collection_bid_id: CollectionBidId) -> Self {
        CollectionOffset {
            collection,
            token_id,
            collection_bid_id,
...
pub enum QueryMsg {
    ...
    Params {},
    #[returns(BidkeyResponse)]
    BidKey { bid_id: BidId },
    #[returns(CollectionBidkeyResponse)]
    CollectionBidKey { collection_bid_id: CollectionBidId },
}
...
#[cw_serde]
pub struct BidkeyResponse {
    pub bidkey: BidKey,
    pub bider:String
}

#[cw_serde]
pub struct CollectionBidkeyResponse {
    pub collection_bidkey: CollectionBidKey,
}
